export function HeaderStats({ total, thisMonth, vehicles }: { total: number; thisMonth: number; vehicles: number }) {
  return (
    <div className="flex gap-3">
      <div className="rounded-lg border border-[#144390]/20 bg-[#F0F4FA] px-3 py-2 text-center">
        <div className="text-xl font-bold text-[#144390]">{thisMonth}</div>
        <div className="text-xs text-[#144390]/70">ce mois</div>
      </div>
