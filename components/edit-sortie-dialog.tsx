      ...
      <div role="dialog" aria-modal="true" aria-labelledby="edit-sortie-title" className="w-full max-w-xl rounded-xl bg-white p-6 shadow-xl">
        ...
        <form ref={formRef} onSubmit={onSubmit} className="flex flex-col gap-3">
          ...
          <div>
            ...
            <input type="date" value={form.date} onChange={(e) => onChange('date', e.target.value)} required onKeyDown={(e) => { if (e.key === 'Enter') formRef.current?.requestSubmit(); }} className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="text" value={form.code_sap} onChange={(e) => onChange('code_sap', e.target.value)} onKeyDown={(e) => { if (e.key === 'Enter') formRef.current?.requestSubmit(); }} className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          <div>
