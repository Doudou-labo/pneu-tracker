    ...
    <div className="mb-6 flex w-fit gap-1 rounded-lg bg-gray-100 p-1" role="tablist" aria-label="Navigation principale">
      {items.map(([value, label]) => (
        <button
          ...
          className={`rounded-md px-4 py-1.5 text-sm font-medium transition-colors ${tab === value ? 'bg-[#144390] text-white shadow' : 'bg-[#E8EEF6] text-gray-500 hover:text-gray-700'}`}
